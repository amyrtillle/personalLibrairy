...
<body class="antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
            <a href="{{ url('/tableaudebord') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Tableau
                de bord</a>
            @else
            <a href="{{ route('login') }}"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="{{ url('/images/profile.png')}}" width=" 128" />
            </div>

            <div class="flex justify-center text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                Bibliothèque MMMi
            </div>
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <p class="text-xl dark:text-gray-400 ">Vous pouvez rechercher un article en cliquant sur le
                                bouton ci-dessous.
                            </p>
                            <hr>
                            <br>
                                    ...
                                    <div class="max-w-xl">
                                        <div class="flex space-x-4">
                                            <div class="flex rounded-md overflow-hidden w-full">
                                                ...
                                                <button type="submit"
                                                    class="inline-flex items-right px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest dark:text-gray-400 sm:text-right sm:ml-0">
                                                    rechercher
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <table class="min-w-full text-left text-sm dark:text-gray-400 sm:text-right sm:ml-0"
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-neutral-500">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4"><img src='/images/{{$livre->image}}' />
                                        </td>
